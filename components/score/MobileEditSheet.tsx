    ...
    >
      <div className="bg-white rounded-t-2xl shadow-2xl border-t border-gray-200">
        ...
        <div className="flex items-center justify-between px-4 pt-3 pb-2">
          ...
          <button onClick={dismiss} aria-label="Close editing panel" className="w-8 h-8 flex items-center justify-center text-gray-400 hover:text-gray-600 transition">
        ...
        {selectedNoteIndex !== null && note && musicXml && onMusicXmlChange && (
          <div className="px-4 pb-8 space-y-3">
            ...
            {/* Delete */}
            <button
              onClick={() => { onMusicXmlChange(deleteNote(musicXml, note), "Delete note"); setSelectedNoteIndex(null); }}
