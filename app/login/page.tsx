      ...
      <div className="max-w-sm w-full space-y-6">
        <div className="text-center">
          <Link href="/" className="text-2xl font-bold text-gray-900 tracking-tight flex items-center justify-center">
            <Logo size={28} className="text-brand-primary mr-1.5" />
        ...
        <div className="space-y-3">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-gray-900 text-white rounded-xl text-sm font-medium hover:bg-gray-800 transition shadow-sm"
          >
          ...
          <>
            ...
            <div className="flex rounded-xl overflow-hidden border border-gray-200 text-xs font-medium">
              <button
                ...
                className={`flex-1 py-2 transition ${devMode === "signin" ? "bg-gray-800 text-white" : "bg-white text-gray-500 hover:bg-gray-50"}`}
              >
                Sign in
              </button>
              <button
                ...
                className={`flex-1 py-2 transition ${devMode === "signup" ? "bg-gray-800 text-white" : "bg-white text-gray-500 hover:bg-gray-50"}`}
              >
                Sign up
              </button>
            </div>
